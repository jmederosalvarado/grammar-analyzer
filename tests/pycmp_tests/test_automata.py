...
from tests.pycmp_tests.test_automata_cases import test_automata_concatenation_states_cases
from tests.pycmp_tests.test_automata_cases import test_automata_concatenation_recognize_cases
...
@pytest.mark.parametrize(('a1', 'a2', 'text', 'recognize'), test_automata_union_recognize_cases)
...
@pytest.mark.parametrize(('a1', 'a2', 'states'), test_automata_concatenation_states_cases)
...
@pytest.mark.parametrize(('a1', 'a2', 'text', 'recognize'), test_automata_concatenation_recognize_cases)
...
@pytest.mark.parametrize(('automaton', 'text', 'recognize'), test_automata_closure_recognize_cases)
...
@pytest.mark.parametrize(('automaton', 'states'), test_automata_minimization_states_cases)
...
@pytest.mark.parametrize(('automaton', 'text', 'recognize'), test_automata_minimization_recognize_cases)
