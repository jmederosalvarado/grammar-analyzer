...
automaton = NFA(
    states=3,
    finals=[2],
    transitions={(0, "a"): [0], (0, "b"): [0, 1], (1, "a"): [2], (1, "b"): [2],},
)
...
test_automata_union_states_cases = [(automaton, automaton, 2 * automaton.states + 2)]
...
test_automata_closure_states_cases = [(automaton, automaton.states + 2)]
...
test_state_minimization_states_cases = [(automaton, 4)]
...
test_automata_minimization_states_cases = [(automaton, 4)]
